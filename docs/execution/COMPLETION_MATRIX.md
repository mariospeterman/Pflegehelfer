...
| G1 — reliable core              | Durable scoped sessions, episodes, proposal revisions, authority and audit exist; Medplum transaction failure is tested                                                               | PARTIAL | Atomic accepted-command transaction, relational leased provider workers/inbound mapping, immutable numbered/checksummed migrations, resource-native reconstruction without the checkpoint Binary, previous-release migration fixtures.             |
| G2 — complete workday           | Six-patient actor-owned handover, interruptible episodes, evidence, defer and receiving-shift receipt work with synthetic data                                                        | PARTIAL | Immutable clinical handover content/addenda, realistic 12-person longitudinal fixture, explicit conflicts/preferences, deterministic handover readout/TTS and two consecutive full shifts.                                                         |
