...
| G2 — complete workday           | Six-person shift over 15 synthetic profiles, zero-assignment handling, immutable assignment snapshot/digest, interruptible episodes, readout, defer and receiving-shift receipt         | PARTIAL | Four-part clinical delta/resource-version snapshot plus append-only addenda, richer explicit conflicts/preferences and two consecutive full-shift browser proofs.                                                                                    |
