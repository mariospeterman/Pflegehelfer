...
export const users: DemoUser[] = [
  ...
  },
  {
    ...
    wardIds: ["rehab-2"],
    patientIds: ["p-anna", "p-luca", "p-mei"],
    managedDevice: true,
    defaultPurpose: "direct-care",
  },
  {
...
export const handovers: Handover[] = [
  {
    ...
    narrative:
      "Anna Beispiel: erhöhter Blutdruck und offene Arztfrage. Luca Demo: Mobilisation geplant. Mei Muster: SpO₂ 94 %, Verlauf beachten.",
    signedBy: "u-nurse",
    acknowledgedBy: null,
    status: "signed",
  ...
  },
  {
    ...
    unresolvedCommunicationIds: ["c-dizziness-anna"],
    narrative:
      "Entwurf: Blutdruckverlauf und Arztantwort bei Anna prüfen; Mobilisation von Luca als offenen Auftrag übergeben.",
    signedBy: null,
    acknowledgedBy: null,
    status: "draft",
